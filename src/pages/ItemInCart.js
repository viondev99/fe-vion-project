...
export function IteminCart({ product }) {
  ...
  return (
    <>
      <div className="text-primary">
        <li className="m-5 border-b-2 border-b-orange-100" key={product.id}>
          <div className="flex">
            ...
            <div className="ml-auto mr-auto mt-auto mb-auto w-3/12">
              <div className="w-full text-left p-1 m-1">
                <p className="break-words text-sm">{product.name}</p>
              </div>

              <div className="w-full text-left p-1 m-1">
                <p className="break-words text-sm">{product.description}</p>
              </div>
            </div>
